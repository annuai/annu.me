    ...
    <section id="about" className="about-section">
      <div className="about-inner">
        ...
        <div className="about-body">
          ...
          <p>
            After a few more internships, I joined frog as a Design Technologist / Industrial
            Designer, where I worked for two years. That experience gave me the chance to work
            across technology, interfaces, and physical products at a deeper level. After that, I
            moved on to start a lifestyle products brand of my own. It was a meaningful experience,
            even though it didn’t turn out the way I had expected.
          </p>

          <p>
            Over time, I found my real calling in bringing technology and physical products
            together. My work today is driven less by aesthetics alone and more by curiosity — how
            things feel in the hand, how materials behave, and how small details shape the
            experience of using something every day. A lot of my process comes from experimentation,
            prototyping, rebuilding, and slowly refining my sense of taste and judgment.
          </p>

          <p>
            Outside of client work, I spend a lot of time building personal projects, improving my
            rendering and prototyping skills, and documenting the process of becoming better at what
            I do. Right now, I’m looking for opportunities where I can continue learning, contribute
            meaningfully, and work on products that thoughtfully combine technology, engineering,
            and design.
          </p>
        </div>
      </div>
