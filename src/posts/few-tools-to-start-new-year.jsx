...
export default function FewToolsToStartTheNewYear() {
    return (
        <>
            ...
            <p>
                A few interesting tools and communities I bookmarked while entering the
                new year — spanning startups, developer culture, habits, AI, and product
                discovery.
            </p>
        </>
    );
