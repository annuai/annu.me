...
export default function ReadingOnInnovation() {
  return (
    <>
      ...
      <p>
        These articles collectively explore how innovation happens — from ideation and design
        thinking to organizational culture, strategic execution, and knowledge sharing.
      </p>
    </>
  );
}
