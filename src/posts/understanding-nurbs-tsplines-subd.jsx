...
export default function UnderstandingNurbsTSplinesSubD() {
    return (
        <>
            ...
            <p>
                3D modeling is an incredible feat in computing. What made advanced CAD
                and surface modeling possible are mathematical representations like
                NURBS and T-Splines — systems capable of describing smooth,
                controllable three-dimensional surfaces with precision.
            </p>

            <p>
                I started exploring the differences between various modeling methods,
                spline types, and how newer workflows like SubD compare with
                traditional NURBS-based modeling used in industrial design and CAD.
            </p>
            ...
            <p>
                What fascinated me most was how different modeling systems influence the
                way designers think and work. NURBS feels engineered and precise,
                whereas SubD workflows feel more sculptural and fluid.
            </p>

            <p>
                Understanding these systems also changed how I looked at industrial
                design surfaces, automotive modeling, consumer products, and even how
                CAD software itself is built under the hood.
            </p>
        </>
    );
}