...
export default function WhenYourOwnWorkStartsLookingBad() {
  return (
    <>
      ...
      <p>When you first make something, you experience it emotionally.</p>
      ...
      <p>You come back and suddenly realize:</p>

      <p>
        <em>“Wait… this is actually not bad.”</em>
      </p>

      <p>Or maybe it is bad.</p>

      <p>But now you can tell why without emotionally collapsing into it.</p>
