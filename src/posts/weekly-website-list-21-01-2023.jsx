...
export default function WeeklyWebsitesList21012023() {
  return (
    <>
      ...
      <p>
        Andrej Karpathy is an AI developer who previously worked at Tesla and OpenAI. His writings
        and explanations around deep learning are some of the most approachable technical resources
        on AI.
      </p>

      <ul>
        <li>
          <a href="http://karpathy.github.io/" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://openai.com/blog/whisper/" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        Lee Robinson is the VP of Developer Experience at Vercel and writes a lot about frontend
        engineering, developer tooling, and systems.
      </p>

      <ul>
        <li>
          <a href="https://leerob.io/blog" target="_blank" rel="noopener noreferrer">
      ...
      <ul>
        <li>
          <a href="https://www.bestbooks.to/" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        This week’s rabbit holes revolved mostly around AI, developer tools, neural networks, and
        how people build systems for learning, creating, and generating ideas over time.
      </p>
    </>
  );
}
