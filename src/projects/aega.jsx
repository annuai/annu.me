  ...
  return (
    <div className="ag-case-study">
        ...
        <div className="ag-intro-grid">
          <div>
            ...
            <p className="ag-subtext">
              ...
              a clock, a hexagonal tray, and a display bar. Each solves a
              specific desktop problem. Together, they form a coherent visual
              system — sharing proportional logic, chamfer language, and a
              preference for geometry over decoration. The collection began as
              an experiment in whether constraint (one palette, one formal
              vocabulary) could produce objects that feel more considered than
              any single piece designed in isolation.
            </p>
          </div>
          ...
          <div className="ag-meta-box">
            ...
            <div className="ag-meta-row">
              ...
              <div className="ag-tags">
                {["3D Modelling", "Visualisation", "Prototyping", "Form Development", "Material Study"].map(t => (
      ...
      <section className="ag-section">
        ...
        <div className="ag-product-section">
          <div className="ag-product-images">
            ...
            <div className="ag-product-images-pair">
              ...
              <div className="ag-image-wrapper" onClick={() => open("/projects/organizer/organizer-2.jpeg")}>
          ...
          <div>
            ...
            <p className="ag-product-desc">
              The Organizer is the anchor of the collection — the piece most
              likely to be the first thing you see on a desk. Three compartments
              at graduated depths: the tallest for pens, scissors, and rulers;
              the mid-depth for markers and styli; the shallowest for business
              cards and small tools.
            </p>
            <p className="ag-product-desc">
              The divider walls are chamfered at their top edges, making it easy
              to reach in and pull out a specific item without disturbing
              everything else. The exterior walls taper by 2° — just enough to
              read as intentional, not enough to compromise stacking.
            </p>
        ...
        <div className="ag-product-section reverse">
          <div className="ag-product-images">
            ...
            <div className="ag-product-images-pair">
              ...
              <div className="ag-image-wrapper" onClick={() => open("/projects/coin-box/coin-box-1.jpeg")}>
          ...
          <div>
            ...
            <p className="ag-product-desc">
              Every pocket generates residue: loose coins, spare SIM card
              tools, rings you take off at the desk, spare buttons, an
              errant earring. The Coin Box gives these objects a designated
              home — compact, lidded, and satisfying to use.
            </p>
            <p className="ag-product-desc">
              The lid friction-fits with deliberate resistance — firm enough
              to feel intentional, light enough to open one-handed. The same
              45° chamfer used on the Organizer's dividers appears at the lid
              perimeter, tying the two pieces together visually. The base
              footprint is small enough to tuck into a corner; the height is
              tall enough to be easy to open.
            </p>
            <div className="ag-product-specs">
              <div className="ag-spec-row">
                <span className="ag-spec-key">Form</span>
        ...
        <div className="ag-product-section">
          ...
          <div>
            ...
            <p className="ag-product-desc">
              A timepiece that reads the time without performing it. There are
              no numerals on the face — just clean quadrant geometry and two
              flat-cut hands oxidised dark against the pale dial. The information
              is there; the decoration is not.
            </p>
            <p className="ag-product-desc">
              The Clock works flat on a desk or mounted to a wall. When
              desk-mounted, a minimal angled stand props it at 15° — readable
              at a glance without requiring a tilt of the head. The case
              profile echoes the Organizer's wall geometry: the same radius,
              the same wall thickness, the same deliberate anonymity.
            </p>
            <div className="ag-product-specs">
              <div className="ag-spec-row">
                <span className="ag-spec-key">Form</span>
        ...
        <div className="ag-product-section reverse">
          ...
          <div>
            ...
            <p className="ag-product-desc">
              The hexagon is the most efficient shape for tiling a plane —
              maximum area, minimum perimeter, zero wasted space when packed
              together. The Hexa Organizer uses that logic to create a tray
              for the objects that resist categorisation: earbuds, cable clips,
              push pins, rings, memory cards.
            </p>
            <p className="ag-product-desc">
              The geometry is a deliberate departure from the Organizer's
              rectangularity — a counterpoint that makes both forms more
              interesting in proximity. The depth is shallow by design:
              deep enough to contain, shallow enough that you can see
        ...
        <div className="ag-product-section">
          ...
          <div>
            ...
            <p className="ag-product-desc">
              The Display Bar is the collection's only wall-mounted piece —
              a horizontal rail for hanging posters, prints, and notes.
              Its lower face has a standard poster-clamp mechanism; its
              upper face incorporates a Lego-compatible stud track.
            </p>
            <p className="ag-product-desc">
              That stud track allows the Hexa Organizer modules and other
      ...
      <section className="ag-section">
        ...
        <p className="ag-caption">
          Prototype photographs shot in natural window light. Render quality confirmed
          against physical prototypes before finalising surface specifications.
        </p>
      </section>
