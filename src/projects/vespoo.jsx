...
const vespooImages = ['/projects/vespoo/vespoo.png', '/projects/vespoo/vespoo-1.png'];
    ...
    <div className="vp-case-study">
      {lightboxIndex !== null && (
        <Lightbox
          ...
          onPrev={() =>
            setLightboxIndex((i) => (i - 1 + vespooImages.length) % vespooImages.length)
          }
      ...
      <section className="vp-intro-section">
        ...
        <h1 className="vp-title">Vespoo — A Smarter Way to Make the Wooden Toy</h1>

        <div className="vp-intro-grid">
          <div>
            <p className="vp-lead">
              Wooden toys are one of the most beloved categories in product design — tactile,
              durable, and timeless. Vespoo started by asking one question: what if you kept
              everything that makes them great, and redesigned the parts that make them hard to
              produce?
            </p>
            <p className="vp-subtext">
              The result is a miniature scooter — a Vespa in spirit — built from two processes
              rather than one: 3D printed PLA for the complex curved body, and CNC routed birch for
              every round, flat, or simply-profiled component. The two materials find each other
              naturally in the final object: warm wood against bold colour, rough-matte surface next
              to smooth-matte surface. It is a desk ornament, a child's toy, and a small argument
              for smarter material allocation in product manufacturing.
            </p>
          </div>
      ...
      <section className="vp-section">
        <div
          className="vp-image-wrapper"
          onClick={() => openLightbox('/projects/vespoo/vespoo.png')}
        >
          <img src="/projects/vespoo/vespoo.png" alt="Vespoo — two colour variants" />
        </div>
        <p className="vp-caption">
          KeyShot render of both production colour variants — Rally Red and Olive Drab. The natural
          birch components (wheels, seat, handlebar, headlight) are shared across colours; only the
      ...
      <section className="vp-section vp-warm-block">
        <div className="vp-split-grid">
          <div className="vp-split-text">
            ...
            <p>
              The market for premium wooden toys is rich — Scandinavian brands, Japanese makers,
              small European workshops — and the wooden push scooter is a recurring form in all of
              them. These toys are beautiful. They are also slow to produce: each part individually
              turned or CNC'd from solid wood stock, assembled by hand, and priced accordingly.
            </p>
            <p>
              The ambition for Vespoo was not to replace these objects but to learn from them. Keep
              the warmth, the weight, the satisfying material contrast — and redesign the production
              logic so the toy can be made more efficiently, with less offcut waste, and opened up
              to more colour options than wood stain and paint allow.
            </p>
            <p>
              The scooter form was chosen deliberately. The Vespa silhouette is one of the most
              recognisable outlines in the world — a gestural shorthand that a child identifies in
              two seconds and an adult appreciates for the rest of their life.
            </p>
          </div>
          <div
            className="vp-image-wrapper"
            onClick={() => openLightbox('/projects/vespoo/vespoo-1.png')}
          >
        ...
        <table className="vp-compare-table">
          ...
          <tbody>
            {[
              [
                'Complex curves',
                'Hand-carved or multi-axis CNC — slow, expensive',
                'FDM printed — fast, cheap, any geometry',
              ],
              [
                'Round parts (wheels, discs)',
                'Lathe-turned or multi-pass CNC',
                'Single-pass CNC rout — maximum sheet yield',
              ],
              [
                'Material waste',
                'Significant offcut from solid wood blanks',
                'Near-zero: additive for 3D print, efficient nesting for CNC',
              ],
              [
                'Colour options',
                'Limited to paints and stains over wood',
                'Any PLA colour on printed parts, natural wood fixed',
              ],
              [
                'Assembly',
                'Often glued or pinned — permanent',
                'Snap-fit and friction — fully reversible',
              ],
              [
                'Price point',
                'High — labour and material-intensive',
                'Lower — streamlined dual-process production',
              ],
            ].map(([attr, old, neo], i) => (
              <tr key={i}>
      ...
      <section className="vp-section">
        ...
        <div className="vp-gallery-grid">
          {[
            ...
            },
            {
              ...
              caption:
                'Rally Red — close-up showing material contrast between PLA body and birch wheels',
            },
          ].map(({ src, caption }) => (
            <div key={src} className="vp-gallery-item" onClick={() => openLightbox(src)}>
        ...
        <p className="vp-caption">
          Rendered in KeyShot. The birch material was built from a procedural wood shader with
          custom grain direction matched to how the CNC cuts would run on a real sheet. Hover over
          each image for notes — click to enlarge.
        </p>
      </section>
