    ...
    <div className="hl-case-study">
      {lightboxIndex !== null && (
        <Lightbox
          ...
          onPrev={() =>
            setLightboxIndex((i) => (i - 1 + hornbillImages.length) % hornbillImages.length)
          }
      ...
      <section className="hl-intro-section">
        ...
        <h1 className="hl-title">Hornbill Lamp — Where Nature's Geometry Meets Warm Light</h1>

        <div className="hl-intro-grid">
          <div>
            <p className="hl-lead">
              The Hornbill Lamp draws from the striking silhouette of one of India's most dramatic
              birds — a creature whose casque, beak, and plumage have inspired artists for
              centuries. Here, that same organic geometry becomes a functional object that lives in
              your home.
            </p>
            <p className="hl-subtext">
              This project started as a personal exploration into biomorphic form-giving — how the
              contours of the natural world can be translated into objects that serve everyday human
              needs without losing any of their original poetry. The lamp is both a functional light
              source and a quiet sculptural statement, designed to cast warm, directional light
              while standing on its own as an object worth looking at in the dark.
            </p>
          </div>
      ...
      <section className="hl-section">
        <div
          ...
          onClick={() => openLightbox('/projects/hornbill-lamp/hornbill-lamp-wide.png')}
        >
          <img
            src="/projects/hornbill-lamp/hornbill-lamp-wide.png"
            alt="Hornbill Lamp — wide render"
          />
        </div>
        <p className="hl-caption">
          The final render of the Hornbill Lamp. The curved arm references the bird's long, arching
          neck, while the shade echoes the characteristic downward curve of its bill. Click any
          image to enlarge.
        </p>
      </section>
      ...
      <section className="hl-section">
        <blockquote className="hl-blockquote">
          <p>
            "Good design is not about imposing a human idea onto material — it is about listening to
            what the form already wants to become."
          </p>
      ...
      <section className="hl-section hl-amber-block">
        <div className="hl-split-grid">
          <div className="hl-split-text">
            ...
            <p>
              The Great Hornbill (<em>Buceros bicornis</em>) is one of the most architecturally
              striking birds in the world. Its casque — the hollow, bony protrusion above the bill —
              functions both as a resonating chamber and a visual display organ. This balance of
              utility and spectacle was the seed of the lamp's design language.
            </p>
            <p>
          ...
          >
            <img
              ...
              alt="Early Hornbill Lamp concept"
            />
          </div>
        </div>
        <p className="hl-caption" style={{ paddingTop: '1rem' }}>
          Early concept exploration — the first iteration, exploring the gesture of the bird's
          silhouette before refining proportions and material language.
        </p>
      </section>
        ...
        <div className="hl-before-after">
          ...
          <div className={`hl-tab-panel ${activeTab === 'concept' ? 'active' : ''}`}>
            ...
            <p className="hl-tab-panel-caption">
              The first concept was bolder and more literal in its bird reference — almost
              totem-like. While interesting as sculpture, it sacrificed too much of the lamp's
              legibility as a functional object. The base was too wide and the shade too deep to
              cast useful light.
            </p>
          </div>
          ...
          <div className={`hl-tab-panel ${activeTab === 'final' ? 'active' : ''}`}>
            ...
            />
            <p className="hl-tab-panel-caption">
              The final design is more refined and restrained. The arm is slimmer, the shade more
              open, and the base footprint is smaller — all changes driven by real-world usability
              tests. The bird reference survives in gesture rather than literal shape.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="hl-section hl-stone-block">
        ...
        <div className="hl-gallery-grid">
          {[
            {
              src: '/projects/hornbill-lamp/hornbill-lamp-1.jpeg',
              caption: 'Lamp off — the form reads as sculpture',
            },
            {
              src: '/projects/hornbill-lamp/hornbill-lamp-2.jpeg',
              caption: 'Switched on — warm light fills the shade',
            },
            {
              src: '/projects/hornbill-lamp/hornbill-lamp-3.jpeg',
              caption: "Close-up of the shade's interior glow",
            },
            {
              src: '/projects/hornbill-lamp/hornbill-lamp.png',
              caption: 'Render vs prototype — colour study',
            },
          ].map(({ src, caption }, i) => (
            <div key={i} className="hl-gallery-item" onClick={() => openLightbox(src)}>
        ...
        <p className="hl-caption" style={{ paddingTop: '1.5rem' }}>
          All prototype photographs shot in natural window light to best capture the lamp's true
          material quality and the warmth of its illumination. Hover over each image for notes,
          click to enlarge.
        </p>
      </section>
      ...
      <section className="hl-section">
        ...
        >
          <img
            src="/projects/hornbill-lamp/hornbill-lamp-wide.png"
            alt="Hornbill Lamp — final hero render"
          />
        </div>
      </section>
